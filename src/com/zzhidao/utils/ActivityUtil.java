...
public final class ActivityUtil {
    ...
    /**
     * 关闭已经显示的输入法窗口�?
     * @param context 上下文对象，�?般为Activity
    ...
    public static void addShortCut(Context context) {
        ...
        Intent intent=new Intent(Intent.ACTION_MAIN);// 标识Activity为一个程序的�?�?
     ...
     * 2.分别从A和B中各取出�?元素a,b，对a和b进行�? 较：<br>
     * 1) 如果a与b相等，则将a或b存入�?指定集合�?<br>
     * 2)如果a小于b，则继续取A的下�?元素，再与b�? �?<br>
     * 3) 如果a大于b，则取B的下�?个元素，与a进行比较<br>
