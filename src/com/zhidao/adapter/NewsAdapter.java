...
import com.zhidao.bean.NewsEntity;
import com.zhidao.tool.Constants;
import com.zhidao.tool.DateTools;
import com.zhidao.tool.Options;
import com.zhidao.view.HeadListView;
import com.zhidao.view.HeadListView.HeaderAdapter;
...
public class NewsAdapter extends BaseAdapter implements SectionIndexer, HeaderAdapter, OnScrollListener{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			view = inflater.inflate(R.layout.item_unknow, null);
