...
public class PersonalFragment extends BaseHomeFragment implements
	...
	private void getCurrentUserInfo() {
		...
		updatePersonalInfo(user);
		ActivityUtil.show(mContext, "鏇存柊淇℃伅鎴愬姛銆?");
		mIProgressControllor.hideActionBarProgress();
	}
