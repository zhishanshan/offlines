...
import com.zzhidao.utils.CacheUtils;
...
public class EditActivity extends BasePageActivity implements OnClickListener {
	...
	private static final int REQUEST_CODE_ALBUM = 1;//album
	private static final int REQUEST_CODE_CAMERA = 2;//camera
	ActionBar actionbar;
	EditText content;
	...
	protected void findViews() {
		// TODO Auto-generated method stub
		content = (EditText) findViewById(R.id.edit_content);//内容
		actionbar = (ActionBar) findViewById(R.id.actionbar_edit);//头部

		openLayout = (LinearLayout) findViewById(R.id.open_layout);//打开相册
		takeLayout = (LinearLayout) findViewById(R.id.take_layout);//拍照
	...
	protected void setupViews(Bundle bundle) {
		...
		actionbar.setDisplayHomeAsUpEnabled(true);//发布功能
		actionbar.setHomeAction(new Action() {//暂时不知道什么意思
