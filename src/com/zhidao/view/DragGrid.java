...
import com.zhidao.tool.DataToolsGrid;
...
public class DragGrid extends GridView {
	...
	public void init(Context context){
		...
		//将布局文件中设置的间距dip转为px
		mHorizontalSpacing = DataToolsGrid.dip2px(context, mHorizontalSpacing);
	}
...
//		if (tempPostion != AdapterView.INVALID_POSITION) {
			...
			GridDragAdapter mDragAdapter = (GridDragAdapter) getAdapter();
			//显示刚拖动的ITEM
